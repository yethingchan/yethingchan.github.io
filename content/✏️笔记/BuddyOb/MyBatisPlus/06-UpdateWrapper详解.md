...
```
> 配合 [[03-BaseMapper的CRUD]] 的 `BlockAttackInnerInterceptor` 兜底，但**写完 Wrapper 先打印 SQL 核对 WHERE** 才是好习惯。
...
> 下一步：[[07-LambdaWrapper与列安全]] 用方法引用替代字符串列名，从根上防"列名写错"。
